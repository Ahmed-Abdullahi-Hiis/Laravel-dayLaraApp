  ...
  <div class="flex h-screen">
    <aside class="w-64 bg-gray-800 text-white flex-shrink-0 h-screen flex flex-col">
      ...
      <nav class="mt-6 flex-1 flex flex-col gap-2 px-2">
        <!-- Dashboard -->
        <a href="{{ route('admin.dashboard') }}" class="flex items-center gap-3 px-4 py-2 bg-blue-600 rounded-lg hover:bg-blue-700 transition duration-200 font-medium text-white">
...
<a href="{{ route('admin.settings') }}" 
   class="flex items-center gap-3 px-4 py-2 bg-blue-600 rounded-lg hover:bg-blue-700 transition duration-200 font-medium text-white">
  <svg class="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
